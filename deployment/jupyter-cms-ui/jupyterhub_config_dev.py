...
# Ensure JupyterHub loads the custom UI templates
c.JupyterHub.template_paths = ['/usr/local/share/jupyterhub/templates_cms']

# Ensure JupyterHub serves custom static assets
c.JupyterHub.static_files_path = '/usr/local/share/jupyterhub/static/external'
